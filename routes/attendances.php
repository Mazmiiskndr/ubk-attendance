...
Route::middleware('auth')->name('backend.')->group(function () {
    ...
    Route::get('attendances/students/date/detail/{id}', [AttendanceController::class, 'showStudentAttendanceByDateDetail'])->name('attendances.students.date.show');
    ...
    Route::get('attendances/lecturers/date/detail/{id}', [AttendanceController::class, 'showLectureAttendanceByDateDetail'])->name('attendances.lecturers.date.show');
