<div>
    <div wire:ignore.self class="modal fade" id="editAttendanceDate" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
    ...
    <script>
        document.addEventListener('livewire:init', function() {
            let myModal = new bootstrap.Modal(document.getElementById('editAttendanceDate'));
