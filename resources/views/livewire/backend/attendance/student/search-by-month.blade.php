<div class="order-2 order-md-2 mb-1 mb-sm-0 text-center">
    <x-input-field id="searchByMonth" model="searchByMonth" placeholder="Cari Berdasarkan Rentang Tanggal.." required style="width:300px" />
</div>

@push('scripts')
<script>
    document.addEventListener('livewire:init', function() {
        let timeFields = ['#searchByMonth'];
                ...
                element.flatpickr({
                    ...
                    , onChange: function(selectedDates, dateStr, instance) {
                        if (selectedDates.length === 1) {
                            ...
                            endDate.setDate(startDate.getDate() + 30); // One week later
