<div wire:ignore class="table">
    <table class="table table-hover table-bordered table-responsive display" id="myTable" data-route="{{ route('attendances.lecturers.date.getDatatable') }}" aria-describedby="myLectureByDateTables">
        <thead>
            <tr>
