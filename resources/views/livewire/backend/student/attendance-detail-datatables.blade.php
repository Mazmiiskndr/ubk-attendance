...
<div wire:ignore class="table text-nowrap">
    <table class="table table-hover table-bordered table-responsive display" id="myTable" data-route="{{ route('attendances.students.detail.date.getDatatable') }}" aria-describedby="myStudentByDateTables">
        <thead>
            <tr>
